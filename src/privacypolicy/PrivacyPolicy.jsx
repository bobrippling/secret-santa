...
const PrivacyPolicy = props => (
    <div className={props.styles.privacyPolicyWrapper}>
        <h1>Privacy Policy for Fennell Secret Santa</h1>

        <p>
            At Fennell Secret Santa, accessible from
            <a href="https://fennell-secret-santa.web.app" className={props.styles.linkOne}>Fennell Secret Santa</a>
        ...
        <p>
            ...
            shared and/or collect in Fennell Secret Santa. This policy is not
        ...
        <p>
            Fennell Secret Santa follows a standard procedure of using log files.
        ...
        <p>
            Like any other website, Fennell Secret Santa uses 'cookies'.
        ...
        <p>
            Fennell Secret Santa's Privacy Policy does not apply to other advertisers or
        ...
        <p>
            Fennell Secret Santa does not knowingly collect any Personal Identifiable
