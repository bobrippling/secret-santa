...
const TermsOfService = props => (
    <div className={props.styles.privacyPolicyWrapper}>
        <h1>Welcome to Fennell Secret Santa</h1>

        <p>
            These terms of service outline the rules and regulations for the use of
            Fennell Secret Santas Website.

            By accessing this website we assume you accept these terms of service in full.
            Do not continue to use Fennell Secret Santas website if you do not accept all of the
            terms of service stated on this page.
        </p>
        ...
        <p>
            ...
            to you, the person accessing this website and accepting the Company's terms of
            service. "The Company", "Ourselves", "We", "Our" and "Us", refers to our
        ...
        <p>
            ...
            meetings of a fixed duration, or any other means, for the express purpose
            of meeting the Client's needs in respect of provision of the Company's
            stated services/products, in accordance with and subject to, prevailing law
        ...
        <p>
            We employ the use of cookies. By using Fennell Secret Santas website you consent
            to the use of cookies in accordance with Fennell Secret Santas privacy policy.
        ...
        <p>
            Unless otherwise stated, Fennell Secret Santa and/or it's licensors own the
            intellectual property rights for all material on Fennell Secret Santa.
            All intellectual property rights are reserved. You may view and/or
            print pages from https://fennell-secret-santa.web.app for your own personal use
            subject to restrictions set in these terms of service.
        </p>
        <p>
            You must not:
            <ul>
                <li>Republish material from https://fennell-secret-santa.web.app</li>
                <li>Sell, rent or sub-license material from https://fennell-secret-santa.web.app</li>
                <li>Reproduce, duplicate or copy material from https://fennell-secret-santa.web.app</li>
            </ul>
            Redistribute content from Fennell Secret Santa (unless content is specifically
        ...
        <p>
            Fennell Secret Santa does not screen, edit, publish or review
            Comments prior to their appearance on the website and Comments do not
            reflect the views or opinions of Fennell Secret Santa, its agents or affiliates.
            Comments reflect the view and opinion of the person who posts such view
            or opinion.
        </p>

        <p>
            To the extent permitted by applicable laws Fennell Secret Santa shall
        ...
        <p>
            Fennell Secret Santa reserves the right to monitor all Comments and to remove any
        ...
        <p>
            ...
            You hereby grant to Fennell Secret Santa a non-exclusive royalty-free license to use,
        ...
        <p>
            ...
            <ul>
                ...
                <li>
                    ...
                    link to our Web site in the same manner as they hyperlink to the
                    Web sites of other listed businesses
                </li>
                <li>
        ...
        <p>
            ...
            to remove links but will have no obligation to do so or to respond directly
            to you.
        </p>
        <p>
        ...
        <p>
            ...
            and skill). Nothing in this disclaimer will:
        ...
        <p>
            ...
            to the subject matter of this disclaimer, including liabilities arising
            in contract, in tort (including negligence) and for breach of statutory
            duty.
        </p>
        <p>
